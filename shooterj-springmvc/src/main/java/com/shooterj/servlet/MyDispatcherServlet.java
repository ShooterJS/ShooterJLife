package com.shooterj.servlet;

import com.shooterj.annotations.MyAutowired;
import com.shooterj.annotations.MyController;
import com.shooterj.annotations.MyRequestMapping;
import com.shooterj.annotations.MyService;
import com.shooterj.pojo.Handler;
    ...
    private void doInstance()  {
        ...
        try{
            ...
            for (int i = 0; i < classNames.size(); i++) {
                String className =  classNames.get(i);  // com.My.demo.controller.DemoController
