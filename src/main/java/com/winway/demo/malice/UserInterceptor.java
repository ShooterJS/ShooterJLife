package com.winway.demo.malice;

import com.winway.demo.exception.BizException;
import com.winway.demo.jedis.RedisUtil;
import com.winway.demo.malice.cache.UserBlackListCache;
import com.winway.demo.miaosha1.config.SystemConfig;
...
//	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		{
			throw new BizException("抢购已经结束啦");
		}
